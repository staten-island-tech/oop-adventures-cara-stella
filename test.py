...
# i think the reason the code may not be working is because when we are importing the Room class and the pickup function the words are grey and undefined. Idk why though?
